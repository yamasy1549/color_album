  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Design" do
        expect {
          post :create, params: {design: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved design as @design" do
        post :create, params: {design: invalid_attributes}, session: valid_session
        expect(assigns(:design)).to be_a_new(Design)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested design" do
        design = Design.create! valid_attributes
        put :update, params: {id: design.to_param, design: new_attributes}, session: valid_session
        design.reload
      ...
      it "assigns the requested design as @design" do
        design = Design.create! valid_attributes
        put :update, params: {id: design.to_param, design: valid_attributes}, session: valid_session
        expect(assigns(:design)).to eq(design)
      end
    ...
    context "with invalid params" do
      it "assigns the design as @design" do
        design = Design.create! valid_attributes
        put :update, params: {id: design.to_param, design: invalid_attributes}, session: valid_session
        expect(assigns(:design)).to eq(design)
      end
